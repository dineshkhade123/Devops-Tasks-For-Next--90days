...
w the content of a file and display line numbers.
nge the access permissions of files to make them readable, writable, and executable by the owner only.
check thest 10 commands you have run.
