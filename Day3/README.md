...
1. w the content of a file and display line numbers.
2. nge the access permissions of files to make them readable, writable, and executable by the owner only.
3. check thest 10 commands you have run.
